...
export default function Home() {
  const [form, setForm] = useState({ name: '', facility: '', email: '', phone: '', claims: '', message: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setStatus('success');
        setForm({ name: '', facility: '', email: '', phone: '', claims: '', message: '' });
      } else {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="DOH-compliant clinical costing for Abu Dhabi healthcare facilities. Just 1 AED per claim — the most affordable clinical costing service in the UAE." />
      ...
      <style>{`
        :root {
          --teal: #00A99D; --teal-dk: #007A71;
          --gold: #C9A84C; --dark: #0D1B1E;
          --mid: #1C2E32; --light: #F4F8F7;
          --muted: #7A9A98; --white: #FFFFFF;
        }
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-cta { background: var(--teal) !important; color: var(--white) !important; padding: 0.45rem 1.2rem !important; border-radius: 4px; transition: background 0.25s !important; }
        ...
        .btn-primary { background: var(--teal); color: var(--white); padding: 0.85rem 2.1rem; border-radius: 4px; text-decoration: none; font-weight: 600; font-size: 0.95rem; letter-spacing: 0.03em; transition: background 0.25s, transform 0.2s; display: inline-flex; align-items: center; gap: 0.5rem; border: none; cursor: pointer; }
        ...
        .form-group input, .form-group select, .form-group textarea {
          background: var(--dark); border: 1px solid rgba(0,169,157,0.2); border-radius: 5px;
          padding: 0.75rem 1rem; color: var(--light); font-family: 'DM Sans', sans-serif; font-size: 0.93rem;
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          ...
          <p className="hero-sub">
            Full DOH-compliant patient-level clinical costing for hospitals, clinics, and medical centers in Abu Dhabi —
            delivered with precision, transparency, and the most competitive pricing in the UAE.
          </p>
        ...
        <div className="inner">
          ...
          <div className="why-grid">
            ...
            <div className="why-stat-box">
              ...
              <br />
              <p style={{color:'var(--teal)', fontWeight:600}}>I make sure you&apos;re never caught unprepared.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="inner">
          ...
          <div className="services-grid">
            {[
              ...
              ['📈','Cost & Profitability Reporting','Understand your true service-line economics. Identify cost drivers, compare expected vs. actual costs per procedure, and discover where you\'re losing money under DRG billing.'],
              ['🔍','Audit-Ready Documentation','Maintain a complete, traceable audit trail for all submitted cost data. Should the DOH audit your facility, you\'ll have clean, organized records ready to present instantly.'],
      ...
      <section className="pricing" id="pricing">
        <div className="pricing-inner">
          ...
          <div className="pricing-card">
            <div className="ribbon">UAE&apos;s Most Affordable</div>
            ...
            <p className="pricing-note">
              Volume discounts available for facilities submitting 50,000+ claims/year.<br />
      ...
      <section className="process" id="process">
        <div className="inner" style={{maxWidth:900}}>
          ...
          <div className="steps">
            {[
              ['Free Consultation & Scoping','We discuss your facility type, claim volume, existing data systems (EMR/HIS/ERP), and timeline. I assess your data quality and outline exactly what\'s needed for your DOH submission.'],
      ...
      <section className="about" id="about">
        <div className="about-inner">
          ...
          <div className="about-box">
            ...
            <p>With the rollout of the Abu Dhabi Clinical Costing Road Map 2025 mandating patient-level cost data from all direct-care facilities, I saw a clear gap: most providers were either unaware of the requirements or couldn&apos;t afford the high fees charged by large consulting firms.</p>
        ...
        <div className="contact-inner">
          ...
          {status === 'success' ? (
            <div className="success-msg">
              ...
              <p>Thank you! I&apos;ll be in touch within 24 hours. Check your inbox — you should have received a confirmation email too.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label htmlFor="facility-type" style={{color:'var(--teal)'}}>Facility Type</label>
                  <select id="facility-type" name="message" value={form.message} onChange={handleChange}>
                    <option value="">Select type...</option>
                    <option>Hospital</option>
                    <option>Medical Center / Polyclinic</option>
                ...
                <div className="form-group full">
                  ...
                  <textarea id="message" name="message" placeholder="Tell me about your facility, your current costing setup, and any specific challenges you're facing with DOH submission..." value={form.message} onChange={handleChange} required />
                </div>
              </div>
